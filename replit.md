...
-   **Services Page Redesign (Nov 2025):** Complete visual overhaul featuring exclusive green brand color scheme (#00FF9C, #c4ff4d), 34 unique premium stock images across Services.tsx and 7 individual service pages (no duplicates), reduced font sizes (hero lg:text-6xl, stats text-4xl, headings text-4xl), enhanced animations with three large green glowing orbs (500-600px) pulsing at staggered intervals, green gradient category tabs, stats section with green gradient cards and hover effects, and green-themed CTA section. AnimatedCounter component refactored to accept isInView prop from parent container for reliable intersection observer triggering in all contexts.
