...
-   **Our Work Page:** Clean, professional portfolio page with dark zinc-950 background, subtle grid pattern, and professional typography. Features minimal hero with "Our Work" heading, clean filter tabs with neutral styling, case study grid with refined hover effects, stats bar with neutral icon styling, and clean CTA section.
