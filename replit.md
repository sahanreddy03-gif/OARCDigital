...
-   **Desktop Carousel Performance Enhancements (Nov 2025):** AI Employees and Revenue horizontal carousels optimized for premium feel with enhanced `useSmoothCarouselDrag` hook. Auto-scroll speed increased from 0.5px/frame to 1.8px/frame (3.6x faster) for more dynamic motion. Drag multiplier increased from 1.2 to 1.6 for more responsive manual control. Momentum system enhanced to work with auto-scroll: uses lighter momentum factor (0.8) when auto-scroll is enabled for smooth blending between user drag and automatic scrolling, with 0.92 damping for natural decay. Both pointer and touch events support momentum on all devices. RAF-based animation ensures 60fps performance with proper cleanup.
...
-   **Contact Information & Global Presence (Nov 2025):** Premium implementation of global contact details across Footer and dedicated Contact page (`/contact`). **Footer:** One subtle phone number per office location (Malta, Chennai, Dubai) displayed in muted zinc-500 typography (text-xs) below address blocks, maintaining clean uncluttered aesthetic. **Contact Page:** Elite Apple/Superside-inspired design with clean hero section, primary contact section (email + Malta HQ phone), and comprehensive global offices grid displaying all department-specific phone numbers organized by location. Malta office includes General Enquiries (+356 7971 1799), Sales (+356 9931 2258), and EU Business Line (+31 6311 60151 - subtle emphasis). Chennai office includes General Enquiries (+91 99005 55588) and Operations Desk (+91 80561 58924). Dubai office includes Business Enquiries (+971 52 647 2981). All phone links use proper tel: protocol formatting. Typography hierarchy uses uppercase tracking-wider labels (text-xs) with restrained green hover accents maintaining premium aesthetic without clutter.
