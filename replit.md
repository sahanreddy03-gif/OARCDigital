...
-   **Logo Typography:** "OARC Digital" uses EB Garamond serif font with "O" and "D" highlighted in white, "arc" and "igital" in muted zinc-400 gray. Consistent styling across navigation and footer via `.font-logo` CSS utility class.
