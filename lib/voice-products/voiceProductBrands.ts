...
export const VOICE_PRODUCTS: VoiceProductBrand[] = [
  {
    ...
    hook: 'Talk to book. We train the agentic ASI brain. You keep control.',
    ...
    faqs: [
      GATE('What is HOST for restaurants in Malta?', 'HOST is OARC Digital\'s agentic restaurant phone AI — answers every inbound call 24/7, books tables, handles allergies and events, escalates to staff when needed. Built for Malta operators; trained only by OARC on your menu and tone.'),
      GATE('Is this the same as H360 Voice Host?', 'Yes — HOST on OARC Digital is the commercial entry. H360 Voice Host at /h360/restaurant-phone-ai-malta is the full product page inside the restaurant stack. Same agentic ASI brain, same training.'),
