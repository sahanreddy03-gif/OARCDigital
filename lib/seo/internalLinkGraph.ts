...
const NODES: LinkNode[] = [
  ...
  {
    path: "/agent-economy",
    title: "AI Agent Economy Malta — Marketing Agents That Work for You",
    shortLabel: "Agent Economy",
    hub: "ai",
    spokes: [
      "/",
      "/ai-agents",
    ...
    anchors: [
      "AI agent economy Malta",
      "marketing agents that work for you",
      "OARC agent marketplace",
      "agentic marketing agents",
    ],
  },
  {
    path: "/creative",
