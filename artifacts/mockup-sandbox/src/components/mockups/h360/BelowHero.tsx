...
/* ─── Shared design tokens (mirrors Hero.tsx) ─────────────────────────────── */
const G = {
  bg:        '#ffffff',
  bgSub:     '#f9fafb',
  bgDark:    '#111111',
...
const PX = { sm: '0 20px', md: '0 40px', lg: '0 80px' };
const PY = { sm: '48px', md: '72px', lg: '96px' };
...
/* ═══════════════════════════════════════════════════════════════════════════
   1. STATS STRIP
   Sunday: 4 large numbers, muted label, border-top, light gray bg
   ═══════════════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════════════
   2. PROBLEM STATEMENT
   Sunday: large editorial headline left-aligned, secondary paragraph, no image
   ═══════════════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Sunday: pill tabs row, selected = white card shadow, panel swaps right
   ═══════════════════════════════════════════════════════════════════════════ */
const TABS = [
  {
    label: 'Direct Orders',
    ...
    card: (
      <div style={{ background: '#f9fafb', borderRadius: 16, padding: 20, border: `1px solid #e5e7eb` }}>
        ...
        <div style={{ background: '#094413', color: '#fff', borderRadius: 12, padding: '12px 14px', fontSize: 13, lineHeight: 1.5, marginBottom: 10 }}>
          "Hey Maria! It's been 3 weeks — your favourite Braġjoli is back on the menu. Table for 2 this Friday?"
        </div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   4. LOGO TRUST STRIP
   Sunday: "Trusted by thousands..." headline + infinite horizontal marquee
   ═══════════════════════════════════════════════════════════════════════════ */
  ...
  return (
    <section style={{ padding: m ? '48px 0' : '72px 0', background: G.bg, borderTop: `1px solid ${G.border}` }}>
      <style>{`
        ...
        .marquee-track { animation: marquee 22s linear infinite; display: flex; gap: 16px; width: max-content; }
      `}</style>
      ...
      {/* Inline testimonials Sunday-style — photo avatar + quote */}
      <div style={{ maxWidth: 1040, margin: '48px auto 0', padding: m ? '0 20px' : '0 40px', display: 'grid', gridTemplateColumns: m ? '1fr' : 'repeat(3,1fr)', gap: 24 }}>
        {[
          ...
          <div key={t.name} style={{ padding: '24px 28px', border: `1px solid ${G.border}`, borderRadius: 16, background: G.bg }}>
            ...
            <p style={{ fontSize: 14, color: G.text, lineHeight: 1.6, fontStyle: 'italic' }}>{t.quote}</p>
          </div>
        ))}
      </div>
    </section>
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Sunday: "Every check now drives value" + FOR OPERATORS / STAFF / GUESTS
   ═══════════════════════════════════════════════════════════════════════════ */
  ...
  const cards = [
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={G.green} strokeWidth="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
      ),
    },
    {
      label: 'FOR STAFF',
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={G.green} strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
      ),
    },
    {
      label: 'FOR GUESTS',
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={G.green} strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
      ),
    },
  ];
  return (
    <section style={{ padding: m ? '64px 24px' : `96px 80px`, background: G.bg, borderTop: `1px solid ${G.border}` }}>
      <div style={{ maxWidth: 1040, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: m ? '1fr' : 'repeat(3,1fr)', gap: 32 }}>
          {cards.map(c => (
            <div key={c.label} style={{ padding: '32px', border: `1px solid ${G.border}`, borderRadius: 16, background: G.bg }}>
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Sunday: left headline + para, right: integration diagram card
   ═══════════════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════════════
   7. DASHBOARD — dark bg section
   Sunday: dark bg, headline left, large mock dashboard card right
   ═══════════════════════════════════════════════════════════════════════════ */
      ...
      <div style={{ maxWidth: 1040, margin: '0 auto', display: m ? 'flex' : 'grid', flexDirection: m ? 'column' : undefined, gridTemplateColumns: '1fr 1.4fr', gap: 56, alignItems: 'center' }}>
        ...
        <div style={{ background: '#1a1a1a', border: `1px solid #2a2a2a`, borderRadius: 20, padding: 24 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12, marginBottom: 20 }}>
            {[
              { label: 'Revenue MTD', value: '€18,420', delta: '+34%', ok: true },
              { label: 'Google rank', value: '#1',       delta: '▲ 9 places', ok: true },
              { label: 'New reviews', value: '29',        delta: 'this month', ok: true },
            ].map(s => (
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Sunday: 3 large quote cards, horizontal scroll, big quotation mark
   ═══════════════════════════════════════════════════════════════════════════ */
const LARGE_QUOTES = [
      ...
      <div ref={ref} style={{ display: 'flex', gap: 20, overflowX: 'auto', padding: m ? '0 24px 24px' : '0 80px 24px', scrollbarWidth: 'none', scrollBehavior: 'smooth' }}>
        {LARGE_QUOTES.map((q, i) => (
          <div key={i} style={{ minWidth: m ? 300 : 400, maxWidth: m ? 300 : 400, padding: '36px 32px', border: `1px solid ${G.border}`, borderRadius: 20, background: G.bg, flexShrink: 0 }}>
            <div style={{ fontSize: 56, lineHeight: 1, color: G.border, fontFamily: 'Georgia, serif', marginBottom: 8, marginTop: -12 }}>"</div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Sunday: "From first visit to forever fan" — dark green bg, white text, CTA
   ═══════════════════════════════════════════════════════════════════════════ */
function LoyaltySection({ m }: { m: boolean }) {
  return (
    <section style={{ background: G.green, padding: m ? '72px 24px' : `96px 80px`, borderTop: `1px solid rgba(255,255,255,0.08)` }}>
      <div style={{ maxWidth: 1040, margin: '0 auto', display: m ? 'flex' : 'grid', flexDirection: m ? 'column' : undefined, gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
        {/* Left */}
        <div>
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Sunday: "24/7 Support" / "7 days to receive QR" / "100% walk-out coverage"
   ═══════════════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════════════
   11. FINAL CTA
   Sunday: headline + sub, form input + submit button
   ═══════════════════════════════════════════════════════════════════════════ */
    ...
    <section style={{ background: G.bg, padding: m ? '72px 24px' : `96px 80px` }}>
      <div style={{ maxWidth: 640, margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ background: G.bg, border: `1.5px solid ${G.border}`, borderRadius: 14, padding: '6px 6px 6px 20px', display: 'flex', alignItems: 'center', gap: 8, maxWidth: 480, margin: '0 auto', boxShadow: '0 4px 32px rgba(0,0,0,0.08)' }}>
          ...
          />
          <button style={{ padding: '11px 20px', background: G.text, color: '#fff', border: 'none', borderRadius: 10, fontSize: 14, fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap' }}>
            Get a free demo
          </button>
        </div>
