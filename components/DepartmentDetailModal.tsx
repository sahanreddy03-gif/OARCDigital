...
function GrowthContent({ onClose }: { onClose: () => void }) {
  const phases: PhaseData[] = [
    { num:"01", label:"They find you", headline:'They <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">find</em> you.', hook:"The ones already looking.", who:"Search team",
    ...
    { num:"02", label:"You find them", headline:'You <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">find</em> them.', hook:"The ones not looking yet.", who:"Reach team",
    ...
    { num:"03", label:"They like you", headline:'They <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">like</em> you.', hook:"They care before they compare.", who:"The Studio",
    ...
    { num:"04", label:"They pick you", headline:'They <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">pick</em> you.', hook:"You beat the other three.", who:"Conversion team",
    ...
    { num:"05", label:"You stay close", headline:'You <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">stay close</em>.', hook:"You never go quiet.", who:"Lifecycle team",
    ...
    { num:"06", label:"They come back", headline:'They <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">come back</em>.', hook:"Again, and again.", who:"Retention team",
...
function MediaContent({ onClose }: { onClose: () => void }) {
  const phases: PhaseData[] = [
    { num:"01", label:"Where it pays", headline:'We put money where it <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">pays.</em>', hook:"Every euro where the return is.", who:"Media strategists",
    ...
    { num:"02", label:"Creative is the lever", headline:'The ad is the <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">lever.</em>', hook:"The ad decides — so we build it.", who:"Ad creatives",
    ...
    { num:"03", label:"Flighted testing", headline:'We fly tests, not <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">bets.</em>', hook:"Many small tests, fast winners.", who:"Media buyers",
    ...
    { num:"04", label:"The loop", headline:'Scale winners. <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">Kill losers.</em>', hook:"More of what works, none of what doesn't.", who:"Media buyers · Analysts",
    ...
    { num:"05", label:"Measured on money", headline:'We prove it in <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">revenue.</em>', hook:"Return in euros, not clicks.", who:"Analysts",
...
function SocialContent({ onClose }: { onClose: () => void }) {
  const phases: PhaseData[] = [
    { num:"01", label:"Where your people are", headline:'We find <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">your people.</em>', hook:"We start where they already scroll.", who:"Strategists",
    ...
    { num:"02", label:"The story", headline:'We find the <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">story.</em>', hook:"The reason they stop scrolling.", who:"Storytellers",
    ...
    { num:"03", label:"The video", headline:'We make the <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">video.</em>', hook:"The way people watch now.", who:"Videographers · Editors",
    ...
    { num:"04", label:"Every platform", headline:'We speak <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">every platform.</em>', hook:"Native everywhere your people are.", who:"Platform leads",
    ...
    { num:"05", label:"How it works", headline:'We know <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">how it works.</em>', hook:"The craft under every post.", who:"The whole team",
    ...
    { num:"06", label:"The community", headline:'We build the <em style="font-family:var(--font-instrument-serif,\'Instrument Serif\',serif);font-style:italic;font-weight:400;color:#E02B20">community.</em>', hook:"Followers who bring you customers.", who:"Community managers",
