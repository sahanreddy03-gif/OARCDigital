...
const THEMES: Record<string, ProductTheme> = {
  ...
  'direct-order': {
    ...
    glow: 'radial-gradient(ellipse 75% 55% at 68% 12%, rgba(74,222,128,0.3) 0%, transparent 50%)',
    gradient: 'linear-gradient(165deg, #030303 0%, #0a1a0f 50%, #050505 100%)',
    heroMetric: { value: '€0', label: 'commission per table order' },
  ...
  'reviews-stars': {
    ...
    accent: '#fbbf24',
    accentSoft: 'rgba(251,191,36,0.14)',
    glow: 'radial-gradient(ellipse 70% 55% at 72% 14%, rgba(251,191,36,0.28) 0%, transparent 50%)',
    gradient: 'linear-gradient(165deg, #0c0a04 0%, #1a1408 48%, #060806 100%)',
    heroMetric: { value: '3×', label: 'more reviews in 90 days' },
  ...
  'loyalty-stamps': {
    ...
    accent: '#a78bfa',
    accentSoft: 'rgba(167,139,250,0.14)',
    glow: 'radial-gradient(ellipse 70% 55% at 70% 15%, rgba(167,139,250,0.28) 0%, transparent 50%)',
    gradient: 'linear-gradient(165deg, #080612 0%, #120a22 50%, #050508 100%)',
    heroMetric: { value: '8th free', label: 'automatic — no paper card' },
  ...
  'wallet-pass': {
    ...
    glow: 'radial-gradient(ellipse 70% 55% at 68% 12%, rgba(129,140,248,0.28) 0%, transparent 50%)',
    gradient: 'linear-gradient(165deg, #06060f 0%, #0f0a22 50%, #050505 100%)',
    heroMetric: { value: '1 tap', label: 'add to Apple & Google Wallet' },
  ...
  'whatsapp-flow': {
    ...
    glow: 'radial-gradient(ellipse 70% 55% at 72% 14%, rgba(34,197,94,0.28) 0%, transparent 50%)',
    gradient: 'linear-gradient(165deg, #040a06 0%, #081612 48%, #050505 100%)',
    heroMetric: { value: '47', label: 'lapsed guests reached this month' },
  ...
  'sms-return': {
    ...
    glow: 'radial-gradient(ellipse 70% 55% at 68% 12%, rgba(96,165,250,0.28) 0%, transparent 50%)',
    gradient: 'linear-gradient(165deg, #04080c 0%, #081018 50%, #050505 100%)',
    heroMetric: { value: '98%', label: 'SMS open rate vs email' },
