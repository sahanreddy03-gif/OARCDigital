  ...
  return (
    <div style={{ padding: '12px 12px 32px', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 5, marginBottom: 16 }}>
        {[
          { rank: '1st', name: 'Competitor 1', stars: 4.8, score: '39/40' },
          { rank: '2nd', name: 'Competitor 2', stars: 4.0, score: '39/40' },
          { rank: '3rd', name: 'Competitor 3', stars: 3.1, score: '39/40' },
        ].map(r => (
      ...
      <div style={{ background:G.text, color:'#fff', borderRadius:10, padding:'11px', textAlign:'center', fontSize:13, fontWeight:600 }}>
        Fix it now with AI
      </div>
...
export default function H360Hero() {
  ...
  /* Scroll → phone parallax — exact Owner.com mechanic */
  useEffect(() => {
    const onScroll = () => {
  ...
  /* Green gradient slab behind phone */
  const greenCard = (
    <div style={{
      position: 'absolute',
      bottom: 0,
  ...
  const phoneMockup = (
    <div style={{
      ...
      {/* Dynamic island */}
      <div style={{ width:105, height:30, background:'#000', borderRadius:20, margin:'0 auto', position:'relative', zIndex:5 }}/>
      {/* Screen */}
      <div style={{ borderRadius:34, overflow:'hidden', background:G.bg, height: isMobile ? 420 : 480, marginTop:-1 }}>
        ...
        {/* Scroll-linked content — translates up as user scrolls */}
    ...
    <div style={{ fontFamily:'"Inter",system-ui,-apple-system,Arial,sans-serif', background:G.bg, color:G.text, overflowX:'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap: isMobile ? 10 : 14 }}>
          ...
          <a href="/h360/demo"
            style={{ padding: isMobile ? '9px 16px' : '9px 20px', background:G.text, color:'#fff', borderRadius:99, fontSize:14, fontWeight:600, cursor:'pointer', letterSpacing:'-0.01em', whiteSpace:'nowrap', textDecoration:'none', display:'inline-block' }}
      ...
      {/* ── HERO — 290vh tall, phone sticky inside ── */}
      <div ref={heroRef} style={{ minHeight:'290vh' }}>
          ...
          {!isMobile && (
            <>
              <div style={{ display:'inline-flex', alignItems:'center', background:G.bg, border:`1.5px solid ${G.border}`, borderRadius:14, padding:'6px 6px 6px 16px', boxShadow:'0 2px 20px rgba(0,0,0,0.07)', gap:8, width:'100%', maxWidth:480 }}>
                ...
                />
                <a href="/h360/demo"
                  style={{ padding:'10px 18px', background:G.green, color:'#f0f9f4', borderRadius:10, fontSize:14, fontWeight:600, cursor:'pointer', whiteSpace:'nowrap', display:'flex', alignItems:'center', gap:6, letterSpacing:'-0.01em', textDecoration:'none' }}
        ...
        {/* ── Sticky phone section — pins while user scrolls 290vh ── */}
        <div style={{
      ...
      {isMobile && (
        <div style={{
          ...
          <div style={{ display:'flex', alignItems:'center', gap:8 }}>
            ...
            />
            <a href="/h360/demo"
              style={{ width:46, height:46, borderRadius:10, background:G.green, display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0, textDecoration:'none' }}
