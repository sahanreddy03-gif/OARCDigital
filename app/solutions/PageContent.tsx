      ...
      <main className="bg-black min-h-screen overflow-x-hidden">
        ...
        <section className="py-24 px-6 border-t border-white/5 bg-black" data-testid="section-solutions-spokes">
          ...
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ItemList",
            "name": "Priority Malta markets for solutions",
            "description": "Locality hubs that pair with OARC creative, AI, and automation solutions.",
            "numberOfItems": 8,
        ...
        <section className="py-12 px-6 border-t border-white/5 bg-black" data-testid="solutions-entity-block">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-3 text-sm text-white/45" data-testid="solutions-malta-location-links">
              Malta markets:{" "}
