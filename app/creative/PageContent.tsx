      ...
      <main className="bg-[#F0FFF4]">
        ...
        <section className="py-12 md:py-16 bg-white border-t border-zinc-100" data-testid="creative-entity-block">
          <div className="container mx-auto px-6 max-w-3xl text-center">
            ...
            <p className="mt-6 text-sm text-zinc-500" data-testid="creative-money-links">
              ...
              {" · "}
              <Link href="/services/automation" className="text-zinc-900 underline-offset-2 hover:underline">Automation</Link>
              {" · "}
              <Link href="/services/seo-services" className="text-zinc-900 underline-offset-2 hover:underline">SEO</Link>
              {" · "}
              ...
              {" · "}
              <Link href="/malta" className="text-zinc-900 underline-offset-2 hover:underline">Malta hubs</Link>
            </p>
            <p className="mt-3 text-sm text-zinc-500" data-testid="creative-malta-location-links">
              Malta markets:{" "}
              <Link href="/malta/valletta" className="text-zinc-800 underline-offset-2 hover:underline">Valletta</Link>
              {" · "}
              <Link href="/malta/sliema" className="text-zinc-800 underline-offset-2 hover:underline">Sliema</Link>
              {" · "}
              <Link href="/malta/st-julians" className="text-zinc-800 underline-offset-2 hover:underline">St Julian&apos;s</Link>
              {" · "}
              <Link href="/malta/mosta" className="text-zinc-800 underline-offset-2 hover:underline">Mosta</Link>
              {" · "}
              <Link href="/malta/birkirkara" className="text-zinc-800 underline-offset-2 hover:underline">Birkirkara</Link>
              {" · "}
              <Link href="/malta/qormi" className="text-zinc-800 underline-offset-2 hover:underline">Qormi</Link>
              {" · "}
              <Link href="/malta/hamrun" className="text-zinc-800 underline-offset-2 hover:underline">Ħamrun</Link>
              {" · "}
              <Link href="/malta/naxxar" className="text-zinc-800 underline-offset-2 hover:underline">Naxxar</Link>
            </p>
          </div>
        </section>
        ...
        <section className="py-20 md:py-28" style={{ backgroundColor: '#FFFFFF' }} data-testid="section-creative-spokes">
          ...
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ItemList",
            "name": "Priority Malta markets for creative",
            "description": "Locality hubs where Malta brands deploy OARC creative systems.",
            "numberOfItems": 8,
