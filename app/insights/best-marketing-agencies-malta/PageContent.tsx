  ...
  return (
    <div className="oi-hero-media">
      <video
        ...
        playsInline
        preload="auto"
        poster="/insights/best-marketing-agencies-malta/hero-cinematic-poster.jpg"
        onPlay={() => setPlaying(true)}
        onPause={() => setPlaying(false)}
      >
        <source src="/insights/best-marketing-agencies-malta/hero-cinematic-1080.mp4" type="video/mp4" />
        <source src="/insights/best-marketing-agencies-malta/hero-cinematic-720.mp4" type="video/mp4" />
      </video>
...
/* ---------- data ---------- */
const SERVICES = [
  { n: "01", name: "Search & SEO", body: "Technical, content and local search for Malta — the discipline that bought this page into existence.", href: "/services/seo-services" },
  { n: "02", name: "Answer-engine & AI visibility", body: "Structured content, schema and entity work so assistants quote you, not a directory.", href: "/services/content-marketing" },
  { n: "03", name: "Paid advertising", body: "Meta, Google and TikTok built around a number we can defend, not a hunch.", href: "/services/paid-advertising" },
  { n: "04", name: "Social & creative", body: "Feeds shot, cut and posted in-house — the same team that makes the ads.", href: "/services/social-media-creative-management" },
  { n: "05", name: "Film & motion", body: "4K production, motion graphics and 3D built to hold attention past the third second.", href: "/services/video-production" },
  { n: "06", name: "Motion design & 3D", body: "Titles, product films and immersive 3D for brands that need to look five years ahead.", href: "/services/motion-design" },
  { n: "07", name: "Websites & product", body: "Fast, editorial, conversion-first Next.js builds — like this one.", href: "/services/web-design" },
  { n: "08", name: "AI staff & agents", body: "Voice receptionists, SDRs and back-office agents that answer when your team can't.", href: "/services/ai-voice-receptionist" },
  { n: "09", name: "Automation & systems", body: "The plumbing between ads, CRM and reporting so leads stop leaking.", href: "/services/automation" },
];
...
const PHASES = [
  {
    ...
    link: { label: "See the method we publish", href: "/insights/best-marketing-agencies-malta#method" },
  },
  {
    n: "Phase 02",
    ...
    <main className="oi">
          ...
          <div className="oi-service-list">
            {SERVICES.map((s, i) => (
              <Link className="oi-service" href={s.href} key={s.n} data-reveal style={{ transitionDelay: `${i * 45}ms` }}>
                ...
                <span className="oi-service-body">{s.body}</span>
      ...
      <section className="oi-band" aria-label="Showreel">
        <video
          ...
          playsInline
          preload="none"
          poster="/insights/best-marketing-agencies-malta/band-faster-poster.jpg"
        >
          <source src="/insights/best-marketing-agencies-malta/band-faster-1080.mp4" type="video/mp4" />
        </video>
          ...
          <div className="oi-marquee-track">
            {[...WORK, ...WORK].map((w, i) => (
              <span className="oi-frame" key={`${w}-${i}`}>
                ...
                <img src={`/insights/best-marketing-agencies-malta/${w}.jpg`} alt="" loading="lazy" />
              </span>
            ))}
          </div>
        </div>
        ...
        <div className="oi-wrap">
          ...
          <div className="oi-foot-links">
            {[
              ...
              ["AI agents", "/ai-agents"],
              ["Malta", "/malta"],
              ["Insights", "/insights/best-marketing-agencies-malta"],
              ["Contact", "/contact"],
            ].map(([l, h]) => (
              <Link href={h} key={h}>
                {l}
