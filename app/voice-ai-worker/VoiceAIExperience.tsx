  ...
  return <main className="va-page">
    <section className="va-hero">
      ...
      <div className="va-hero-grid va-wrap">
        ...
        <div className="va-hero-art" aria-label="Illustrated Voice AI Worker workflow"><div className="va-demo-head"><span>LIVE WORKFLOW / HOSPITALITY</span><b>04:12</b></div><div className="va-demo-request"><span>INCOMING CALL</span><strong>“Can I move my booking to Friday?”</strong><small>Customer · Maria Borg · Existing record</small></div><div className="va-demo-path"><div><span>01 / UNDERSTAND</span><strong>Intent recognised</strong><small>Change reservation · Friday · 2 guests</small></div><i>↓</i><div><span>02 / ACT</span><strong>Calendar updated</strong><small>Table held · confirmation prepared</small></div><i>↓</i><div><span>03 / PROVE</span><strong>Work completed</strong><small>SMS sent · CRM record attached</small></div></div><div className="va-demo-footer"><span>HUMAN HANDOFF</span><b>NOT NEEDED</b></div></div>
      </div>
