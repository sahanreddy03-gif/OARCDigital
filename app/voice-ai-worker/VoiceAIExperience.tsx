  ...
  return <main className="va-page">
    <section className="va-hero">
      ...
      <div className="va-hero-grid va-wrap">
        <div className="va-hero-copy"><p className="va-overline">THE OPERATING LAYER FOR CONVERSATIONS</p><h1>AI phone receptionist Malta —<br/><i>calls become completed work.</i></h1><p className="va-hero-lede">A managed Voice AI Worker that answers, understands, acts inside your systems, and hands off the decisions that need a person.</p><div className="va-hero-actions"><Link href="#industries" className="va-button va-button-dark">Choose your industry <span>↓</span></Link><Link href="/voice-ai-worker/start" className="va-button va-button-line">Get a workflow map <span>↗</span></Link></div></div>
