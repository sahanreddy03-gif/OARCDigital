  ...
  return <main className="va-page">
    <section className="va-hero">
      ...
      <div className="va-hero-grid va-wrap">
        ...
        <div className="va-hero-art"><div className="va-orb va-orb-a"/><div className="va-orb va-orb-b"/><div className="va-hero-screen"><span>LIVE / 00:04</span><strong>REQUEST → RESULT</strong><div className="va-screen-line"/><small>reservation updated<br/>confirmation sent<br/>record attached</small></div></div>
      </div>
