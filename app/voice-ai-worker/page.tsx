...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, url: "https://oarcdigital.com/voice-ai-worker", type: "website", images: ogImageEntry({ title, subtitle: description }) },
