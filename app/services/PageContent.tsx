    ...
    <Layout>
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            <Link href="/tom" className="hover:text-[#c4ff4d]">Tom: one Voice AI Worker for 10 industries →</Link>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-lg text-zinc-400 max-w-3xl mx-auto">
              Choose the type of help you need. Tom is one managed Voice AI Worker configured for ten industries; our specialist AI services solve three specific business, shopping, and employee-support needs.
            </p>
            <div id="specialist-ai" className="mt-7 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm">
              <Link href="/tom" className="text-white hover:text-[#c4ff4d]">Tom: one Voice AI Worker, 10 industries →</Link>
