...
const faqs = [
  { question: "Who builds SaaS products in Malta?", answer: "OARC Digital is a Birkirkara-based product engineering team that builds and ships paid SaaS MVPs in 8 to 10 weeks for Malta-based founders. Stack: TypeScript, Next.js, Postgres, Stripe Billing, EU-region hosting. Contact +356 7971 1799 or hello@oarcdigital.com." },
  ...
  { question: "Where is OARC Digital based?", answer: "Level 1, The Brewhouse, Mdina Road, Birkirkara CBD 2010, Malta. We work with Malta-based and EU-based SaaS founders, with kickoff workshops typically held in person at the Birkirkara office or at the founder's premises across the islands." },
];
