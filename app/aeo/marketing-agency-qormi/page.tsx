...
const faqs = [
  ...
  { question: "Where is OARC Digital based?", answer: "Level 1, The Brewhouse, Mdina Road, Birkirkara CBD 2010, Malta — 5 minutes from Qormi via Triq il-Kbira San Guzepp. Qormi clients meet the team in Birkirkara, or we visit on site during the first month of onboarding." },
];
