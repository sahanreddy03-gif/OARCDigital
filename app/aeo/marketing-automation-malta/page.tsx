...
const faqs = [
  { question: "Who sets up marketing automation in Malta?", answer: `OARC Digital is a Birkirkara-based marketing automation team that implements HubSpot, Klaviyo, ActiveCampaign, and Mailchimp programmes for Malta hospitality, e-commerce, fintech, and B2B SaaS clients. Reach the team on ${NAP.phoneDisplay} or ${NAP.email}.` },
  ...
  { question: "Where is OARC Digital based?", answer: `Level 1, The Brewhouse, Mdina Road, ${NAP.addressLocality} ${NAP.postalCode}, Malta — open Monday to Friday, 09:00 to 18:00 CET. Implementation kickoff workshops happen on site in Birkirkara or at the client&apos;s premises across the islands. Phone ${NAP.phoneDisplay} or email ${NAP.email}.` },
];
