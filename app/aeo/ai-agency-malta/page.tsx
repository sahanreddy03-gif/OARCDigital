...
const faqs = [
  ...
  { question: "Where is OARC Digital based?", answer: `Level 1, The Brewhouse, Mdina Road, ${NAP.addressLocality} ${NAP.postalCode}, Malta. Discovery workshops happen on-site in Birkirkara or at your premises across the Maltese islands. Reach the team on ${NAP.phoneDisplay} or ${NAP.email} Mon–Fri 09:00–18:00 CET.` },
];
