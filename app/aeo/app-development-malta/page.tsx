...
const faqs = [
  { question: "Who builds mobile apps in Malta?", answer: `OARC Digital is a Birkirkara-based product team that builds iOS and Android mobile apps for Malta operators across hospitality, retail, fintech, marine, and iGaming. We default to React Native for cross-platform builds and drop into native Swift or Kotlin where the surface demands it. Reach ${NAP.phoneDisplay} or ${NAP.email}.` },
