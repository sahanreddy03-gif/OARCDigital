...
const faqs = [
  { question: "Who installs CRM systems for Malta businesses?", answer: `OARC Digital is a Birkirkara-based CRM consultancy that installs and operates Pipedrive, HubSpot, and Zoho Bigin for Malta hospitality groups, fintech operators, B2B SaaS startups, professional services firms, and trades businesses. We handle migration, pipeline design, automation, and team training. Reach us on ${NAP.phoneDisplay} or ${NAP.email}.` },
  ...
  { question: "Where is OARC Digital based?", answer: `Level 1, The Brewhouse, Mdina Road, ${NAP.addressLocality} ${NAP.postalCode}, Malta — open Monday to Friday, 09:00 to 18:00 CET. CRM kickoff workshops happen on site in Birkirkara or at the client&apos;s premises across the islands. Phone ${NAP.phoneDisplay} or email ${NAP.email}.` },
];
