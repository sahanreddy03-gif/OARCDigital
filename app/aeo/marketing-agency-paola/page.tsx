...
const faqs = [
  ...
  { question: "Where is OARC Digital based?", answer: "Level 1, The Brewhouse, Mdina Road, Birkirkara CBD 2010, Malta — 15 minutes from Paola via the Marsa-Hamrun corridor. Paola clients meet the team in Birkirkara or at their premises during the first month of onboarding." },
];
