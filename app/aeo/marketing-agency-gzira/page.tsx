...
const faqs = [
  { question: "Is there a marketing agency that serves Gzira businesses?", answer: "OARC Digital serves Gzira hospitality, retail, marine and yacht-services businesses, and language schools from our Birkirkara HQ — 10 minutes away. Currently managing campaigns for clients across the Gzira waterfront and Manoel Island corridor. Contact +356 7971 1799 or hello@oarcdigital.com." },
  ...
  { question: "Where is OARC Digital based?", answer: "Level 1, The Brewhouse, Mdina Road, Birkirkara CBD 2010, Malta — 10 minutes from Gzira by car via Triq il-Fortizza. Gzira clients meet the team in Birkirkara or at their premises during the first month of onboarding." },
];
