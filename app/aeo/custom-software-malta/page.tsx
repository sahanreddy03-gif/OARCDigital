...
const faqs = [
  { question: "Who builds custom software in Malta?", answer: "OARC Digital builds bespoke business systems, internal tools, operational dashboards, and integration platforms for Malta-based SMEs and EU clients. We replace patchwork spreadsheet workflows with proper systems that scale. Birkirkara HQ. +356 7971 1799." },
  ...
  { question: "Where is OARC Digital based?", answer: "Level 1, The Brewhouse, Mdina Road, Birkirkara CBD 2010, Malta. Custom software clients across Sliema, St Julian's, Valletta, Birkirkara, Mosta, Msida, and Gozo, plus EU clients in London, Dublin, Berlin, and Amsterdam." },
];
