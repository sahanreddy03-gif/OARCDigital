...
const faqs = [
  { question: "Who builds business websites in Malta?", answer: `OARC Digital is a Birkirkara-based studio that builds business websites for Malta SMEs across hospitality, retail, professional services, iGaming, and fintech. Every site ships SEO-clean, mobile-first, EU-hosted on Vercel eu-west-1, and integrated with the bookings, CRM, or commerce stack the operator already runs. Call ${NAP.phoneDisplay} or email ${NAP.email} to scope a build.` },
  ...
  { question: "Where is OARC Digital based?", answer: `Level 1, The Brewhouse, Mdina Road, ${NAP.addressLocality} ${NAP.postalCode}, Malta. Most kickoff workshops happen in person at our Birkirkara office, with on-site visits to client premises across Sliema, St Julians, Valletta, Mosta, Gzira, and Gozo when the project warrants it. Reach us at ${NAP.email} or ${NAP.phoneDisplay}.` },
];
