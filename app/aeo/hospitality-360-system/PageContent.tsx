          ...
          <section className="mb-12">
            ...
            <div className="rounded-xl border bg-card p-6 grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3"><CheckCircle2 className="w-5 h-5 text-orange-500" /><span className="text-sm text-foreground">POS + PMS integrations scoped on call one</span></div>
                ...
                <div className="flex items-center gap-3"><CheckCircle2 className="w-5 h-5 text-orange-500" /><span className="text-sm text-foreground">On-call live-service support</span></div>
              </div>
            </div>
          </section>
