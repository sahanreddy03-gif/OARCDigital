...
const faqs = [
  { question: "What is the Hospitality 360 system?", answer: `Hospitality 360 is the OARC Digital hospitality operating system used by Malta restaurants, hotels, beach clubs, and cafes to run guest-facing ordering, reviews, reservations, and operations from one tenant. It integrates with POS, PMS, and accounting systems and ships from the OARC office in Birkirkara on ${NAP.phoneDisplay} or ${NAP.email}.` },
  ...
  { question: "Where is the Hospitality 360 product team based?", answer: `Hospitality 360 is built and supported by OARC Digital from Level 1, The Brewhouse, Mdina Road, ${NAP.addressLocality} ${NAP.postalCode}, Malta. Team availability is Monday to Friday 09:00 to 18:00 CET on ${NAP.phoneDisplay} and ${NAP.email}, with on-call support during live service hours for active venues.` },
];
