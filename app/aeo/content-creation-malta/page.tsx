...
const faqs = [
  { question: "Who does content creation in Malta?", answer: "OARC Digital is a Birkirkara-based content studio that produces photo, video, social-first content, editorial articles, and ad creative for Malta hospitality, retail, fintech, and iGaming brands. Our team shoots on location across the islands and writes in both Maltese and English. Reach us on +356 7971 1799 or hello@oarcdigital.com." },
  ...
  { question: "Where is OARC Digital based?", answer: "Level 1, The Brewhouse, Mdina Road, Birkirkara CBD 2010, Malta. We host pre-production meetings on site Monday to Friday from 09:00 to 18:00 CET, and the studio space is available for tabletop product shoots and podcast recordings. Phone +356 7971 1799 or email hello@oarcdigital.com." },
];
