...
const faqs = [
  ...
  { question: "Where is OARC Digital based?", answer: `Level 1, The Brewhouse, Mdina Road, ${NAP.addressLocality} ${NAP.postalCode}, Malta. Creator briefings happen at the office or at the client venue across Malta and Gozo. Email ${NAP.email} or call ${NAP.phoneDisplay} to discuss a single launch activation, a quarterly campaign, or an always-on creator retainer.` },
];
