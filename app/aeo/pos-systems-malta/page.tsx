...
const faqs = [
  ...
  { question: "Where is OARC Digital based?", answer: "Level 1, The Brewhouse, Mdina Road, Birkirkara CBD 2010, Malta — central to every Maltese restaurant cluster from Valletta to Mellieha. Hours Monday to Friday 09:00 to 18:00 CET on +356 7971 1799 and hello@oarcdigital.com, with on-site installs across the islands." },
];
