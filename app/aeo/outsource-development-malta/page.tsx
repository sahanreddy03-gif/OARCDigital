...
const faqs = [
  { question: "Is OARC Digital an outsourced development partner in Malta?", answer: "Yes. OARC Digital takes on outsourced engineering work for Malta-based and EU-based businesses — fixed-scope SaaS MVPs, mobile apps, web platforms, and dedicated team augmentation. Birkirkara HQ. Contact +356 7971 1799 or hello@oarcdigital.com." },
  ...
  { question: "Where is OARC Digital based?", answer: "Level 1, The Brewhouse, Mdina Road, Birkirkara CBD 2010, Malta. The engineering team is co-located in Birkirkara with overflow capacity in our Lisbon partner studio for spike work." },
];
