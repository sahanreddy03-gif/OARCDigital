...
const processPhases = [
  {
    ...
    title: "Discovery",
    duration: "Week 1",
    description: "We closely examine your business processes, pain points, and goals, and map everything.",
    color: "#c4ff4d"
  },
  {
    phase: "02",
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: "We do both - and often together. Many clients start with automation to solve immediate operational pain, then expand into custom software for unique competitive advantages. Having one team handle both means tight integration."
  },
  {
              ...
              <GlassCard className="p-8 md:p-12 relative overflow-hidden" variant="strong">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-white/60 text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
                    ...
                    Having one team handle both means tight integration, faster delivery,
