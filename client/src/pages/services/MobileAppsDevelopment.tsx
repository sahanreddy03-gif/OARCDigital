...
export default function MobileAppsDevelopment() {
  ...
  return (
    <Layout>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <SiApple className="w-6 h-6 text-white/60" />
                <SiGoogleplay className="w-5 h-5 text-white/60" />
              </div>
              ...
              <Link href="/contact">
                <button
                  className="inline-flex items-center gap-3 bg-violet-500 text-white rounded-full pl-8 pr-4 py-4 text-lg font-bold hover:bg-violet-600 transition-colors"
            ...
            <div className="relative">
              <div className="bg-zinc-900 rounded-3xl p-6 border border-zinc-800 shadow-2xl">
                <div className="flex items-start gap-4 mb-6">
                  <div className="w-20 h-20 bg-gradient-to-br from-violet-500 to-blue-500 rounded-2xl flex items-center justify-center">
                    <Smartphone className="w-10 h-10 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-white font-bold text-lg">Your App Name</h3>
                    <p className="text-white/50 text-sm">Your Company</p>
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <span className="text-white/50 text-sm">4.9 · 10K+ reviews</span>
                    </div>
                  </div>
                </div>
                ...
                <button 
                  className="w-full py-3 bg-violet-500 text-white font-bold rounded-xl hover:bg-violet-600 transition-colors"
                ...
                {roadmapPhases.map((phase) => (
                  ...
                  >
                    ...
                    <div className={`p-6 rounded-2xl transition-all ${
                      ...
                      <div className="text-violet-400 text-xs font-bold mb-2">{phase.timeline}</div>
                      ...
                      <ul className="space-y-2">
                        {phase.milestones.map((milestone, i) => (
                          <li key={i} className="flex items-center gap-2 text-white/60 text-sm">
                            <CheckCircle2 className={`w-4 h-4 ${activePhase >= phase.id ? 'text-violet-400' : 'text-zinc-600'}`} />
                            {milestone}
                          </li>
                        ))}
                      </ul>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-end justify-between mb-12">
              <div>
                ...
                <p className="text-white/50 mt-2">Real products, real users</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                >
                  ...
                  <div className="p-6">
                    <span className="text-violet-400 text-xs font-bold">{app.type}</span>
        ...
        <section className="py-20 px-4 bg-zinc-950">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-white/50">Native when you need performance. Cross-platform when you need speed.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-8 rounded-2xl bg-zinc-900 border border-zinc-800">
                ...
                <p className="text-white/50 text-sm mb-6">Maximum performance, full platform access</p>
                ...
                <div className="flex items-center gap-6 mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <SiKotlin className="w-8 h-8 text-violet-500" />
              ...
              <div className="p-8 rounded-2xl bg-zinc-900 border border-zinc-800">
                ...
                <p className="text-white/50 text-sm mb-6">One codebase, both platforms</p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                ...
                <div 
                  key={i}
                  className="p-5 rounded-2xl border border-zinc-200 hover:border-violet-500 hover:shadow-lg transition-all text-center group"
      ...
      {/* Stats */}
      <section className="py-16 px-4 bg-violet-500">
        <div className="max-w-6xl mx-auto">
      ...
      <section className="py-20 px-4 bg-zinc-950 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/contact">
            <button
              className="inline-flex items-center gap-3 bg-violet-500 text-white rounded-full pl-10 pr-4 py-5 text-lg font-bold hover:bg-violet-600 transition-colors"
