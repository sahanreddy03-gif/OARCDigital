    ...
    <Layout>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            Funnels that convert <span className="italic bg-gradient-to-r from-[#c4ff4d] to-[#23AACA] text-transparent bg-clip-text">while you sleep</span>
          </h1>
          ...
          <div className="bg-white rounded-2xl overflow-hidden border border-border shadow-lg">
            <div className="p-8 md:p-12">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                <div>
                  <div className="text-2xl font-bold text-[#23AACA] mb-2">312% increase</div>
                  <div className="text-sm text-muted-foreground">Email-attributed revenue</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#23AACA] mb-2">67% open rate</div>
                  <div className="text-sm text-muted-foreground">Automated sequence performance</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#23AACA] mb-2">$280K</div>
      ...
      <section className="py-16 bg-[#f5f0e6] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 mb-10">
          <div className="text-sm uppercase tracking-wider text-[#23AACA] mb-3">AUTOMATION WORKFLOWS</div>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Every stage. <span className="italic text-[#23AACA]">Every touchpoint.</span>
          </h2>
              ...
              <div key={i} className="flex-none w-[340px] md:w-[420px] group" data-testid={`card-workflow-${i}`}>
                <div className="bg-white rounded-xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-border h-full hover:-translate-y-2">
                  <div className="relative h-48 bg-[#f5f0e6] overflow-hidden flex items-center justify-center">
                    <workflow.icon className="h-16 w-16 text-[#23AACA]/30 group-hover:scale-110 transition-transform duration-500" />
                  </div>
                  <div className="p-6">
                    <h3 className="text-xl font-bold mb-3 group-hover:text-[#23AACA] transition-colors">{workflow.name}</h3>
      ...
      <section className="py-20 px-4 bg-[#f5f0e6]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              How we work: <span className="italic text-[#23AACA]">Map, build, optimize</span>
            </h2>
      ...
      <section className="py-20 px-4 bg-[#f5f0e6]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Built for businesses ready to <span className="italic text-[#23AACA]">scale with automation</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-xl bg-[#f5f0e6] border border-border hover-elevate" data-testid="use-case-saas">
            ...
            <div className="p-6 rounded-xl bg-[#f5f0e6] border border-border hover-elevate" data-testid="use-case-b2b-services">
            ...
            <div className="p-6 rounded-xl bg-[#f5f0e6] border border-border hover-elevate" data-testid="use-case-digital-products">
            ...
            <div className="p-6 rounded-xl bg-[#f5f0e6] border border-border hover-elevate" data-testid="use-case-memberships">
            ...
            <div className="p-6 rounded-xl bg-[#f5f0e6] border border-border hover-elevate" data-testid="use-case-professional-services">
      ...
      <section className="py-16 px-4 bg-[#f5f0e6]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-sm uppercase tracking-wider text-[#23AACA] mb-3">MAXIMIZE YOUR AUTOMATION</div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Pair with these <span className="italic text-[#23AACA]">complementary services</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/services/email-marketing">
              <div className="group p-8 bg-white rounded-xl border border-border hover:border-[#23AACA] hover:shadow-lg transition-all duration-300 cursor-pointer hover-elevate" data-testid="related-service-email-marketing">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-xl font-bold group-hover:text-[#23AACA] transition-colors">Email Marketing</h3>
            ...
            <Link href="/services/lead-generation">
              <div className="group p-8 bg-white rounded-xl border border-border hover:border-[#23AACA] hover:shadow-lg transition-all duration-300 cursor-pointer hover-elevate" data-testid="related-service-lead-generation">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-xl font-bold group-hover:text-[#23AACA] transition-colors">Lead Generation</h3>
                  <ArrowRight className="h-5 w-5 text-[#23AACA] group-hover:translate-x-1 transition-transform" />
                </div>
                <p className="text-sm text-muted-foreground mb-4">
