...
import { Presentation, Sparkles, TrendingUp, Users, FileText, Award, CheckCircle2, DollarSign, Briefcase, ArrowRight } from "lucide-react";
    ...
    <Layout>
          ...
          <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800">
            <div className="p-8 md:p-12">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                <div>
                  <div className="text-2xl font-bold text-[#c4ff4d] mb-2">$25M raised</div>
                  <div className="text-sm text-white/70">Series A round oversubscribed</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#c4ff4d] mb-2">8 of 10 met</div>
                  <div className="text-sm text-white/70">VCs requested follow-up meetings</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#c4ff4d] mb-2">72 hours</div>
                  <div className="text-sm text-white/70">From brief to final deck</div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                {['Investor Pitch', 'Data Visualization', 'Storytelling', 'Financial Projections', 'Market Analysis'].map((tag, i) => (
                  <span key={i} className="px-3 py-1 bg-[#23AACA]/20 text-[#23AACA] rounded-full text-sm font-medium">
                    {tag}
                  </span>
                ))}
              </div>
      ...
      <section className="py-16 bg-[#f5f0e6] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 mb-10">
          <div className="text-sm uppercase tracking-wider text-[#23AACA] mb-3">PRESENTATION TYPES</div>
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#1a2e29]">
            Every format. <span className="italic text-orange-500">Every occasion.</span>
          </h2>
            ...
            {[
              ...
              <div key={i} className="flex-none w-[340px] md:w-[420px] group" data-testid={`card-type-${i}`}>
                <div className="bg-white rounded-xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-border h-full hover:-translate-y-2">
                  <div className="relative h-48 bg-gradient-to-br from-[#23AACA]/10 via-[#23AACA]/10 to-orange-500/10 overflow-hidden flex items-center justify-center">
                    <type.icon className="h-16 w-16 text-[#23AACA]/30 group-hover:scale-110 transition-transform duration-500" />
                  </div>
                  <div className="p-6">
                    <h3 className="text-xl font-bold mb-3 group-hover:text-[#23AACA] transition-colors">{type.name}</h3>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              How we work: <span className="italic text-orange-500">Story to slides</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#1a2e29]">
              Built for those who <span className="italic text-white">need to persuade</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl p-8 border border-border hover-elevate" data-testid="use-case-startups">
            ...
            <div className="bg-white rounded-xl p-8 border border-border hover-elevate" data-testid="use-case-sales">
            ...
            <div className="bg-white rounded-xl p-8 border border-border hover-elevate" data-testid="use-case-executives">
            ...
            <div className="bg-white rounded-xl p-8 border border-border hover-elevate" data-testid="use-case-consultants">
            ...
            <div className="bg-white rounded-xl p-8 border border-border hover-elevate" data-testid="use-case-product">
            ...
            <div className="bg-white rounded-xl p-8 border border-border hover-elevate" data-testid="use-case-speakers">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              Amplify your message with <span className="italic text-[#c4ff4d]">complementary services</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/services/branding">
              <div className="group p-8 bg-zinc-900 rounded-xl border border-zinc-800 hover:border-[#23AACA] transition-all duration-300 cursor-pointer hover-elevate" data-testid="related-service-branding">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-xl font-bold text-white group-hover:text-[#c4ff4d] transition-colors">Branding Services</h3>
            ...
            <Link href="/services/video-production">
              <div className="group p-8 bg-zinc-900 rounded-xl border border-zinc-800 hover:border-[#23AACA] transition-all duration-300 cursor-pointer hover-elevate" data-testid="related-service-video">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-xl font-bold text-white group-hover:text-[#c4ff4d] transition-colors">Video Production</h3>
                  <ArrowRight className="h-5 w-5 text-[#c4ff4d] group-hover:translate-x-1 transition-transform" />
                </div>
                <p className="text-white/70 mb-4">
            ...
            <Link href="/services/customer-acquisition">
              <div className="group p-8 bg-zinc-900 rounded-xl border border-zinc-800 hover:border-[#23AACA] transition-all duration-300 cursor-pointer hover-elevate" data-testid="related-service-growth">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-xl font-bold text-white group-hover:text-[#c4ff4d] transition-colors">Customer Acquisition</h3>
                  <ArrowRight className="h-5 w-5 text-[#c4ff4d] group-hover:translate-x-1 transition-transform" />
                </div>
                <p className="text-white/70 mb-4">
      ...
      {(() => {
        const presentationFAQs: FAQItem[] = [
          { question: "What presentation services do you offer?", answer: "Investor pitch decks, sales presentations, keynote designs, corporate templates, and animated presentations. Professional storytelling." },
          { question: "What platforms do you design for?", answer: "PowerPoint, Keynote, Google Slides, and Figma. We work with whatever platform your team prefers." },
          { question: "How long does pitch deck design take?", answer: "Standard decks take 1-2 weeks. Complex investor presentations with custom illustrations require 3-4 weeks." },
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#23AACA] via-[#23AACA] to-orange-500"></div>
