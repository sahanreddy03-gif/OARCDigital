          ...
          <div className="grid md:grid-cols-4 gap-6 mt-10">
            {[
              ...
              <div key={i} className="text-center p-6 bg-gradient-to-br from-orange-50 to-white rounded-xl border border-border hover:shadow-lg transition-all duration-300 hover:-translate-y-1" data-testid={`metric-${i}`}>
                <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-orange-600 to-red-600 text-transparent bg-clip-text mb-2">{stat.value}</div>
        ...
        <div className="relative">
          <div className="flex gap-6 overflow-x-auto pb-6 px-4 scrollbar-hide snap-x snap-mandatory">
            {[
              ...
              <div key={i} className="flex-none w-[340px] md:w-[420px] snap-center group" data-testid={`card-test-${i}`}>
