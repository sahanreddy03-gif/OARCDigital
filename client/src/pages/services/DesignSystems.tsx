        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-10">
            {[
              ...
              <div key={i} className="text-center p-6 bg-gradient-to-br from-[hsl(140,10%,98%)] to-white rounded-xl border border-border hover:shadow-lg transition-all duration-300 hover:-translate-y-1" data-testid={`metric-${i}`}>
                <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[hsl(140,60%,45%)] to-[hsl(160,60%,55%)] text-transparent bg-clip-text mb-2">{stat.value}</div>
