    ...
    <Layout>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl">
            <div className="group" data-testid="contact-email">
              ...
              <a 
                ...
                className="text-2xl font-semibold text-foreground hover:text-[#16a34a] transition-colors"
            ...
            <div className="group" data-testid="contact-phone-primary">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="text-xs uppercase tracking-wider text-muted-foreground font-medium">Malta HQ</p>
              </div>
              <a 
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <h2 className="text-sm uppercase tracking-wider text-muted-foreground mb-12 font-medium">Our Offices</h2>
          
          <div className="grid md:grid-cols-3 gap-12 lg:gap-16">
            {/* Malta */}
            <div data-testid="office-malta">
              <div className="mb-6">
                <h3 className="text-2xl font-bold mb-4">Malta</h3>
            ...
            <div data-testid="office-chennai">
              <div className="mb-6">
                <h3 className="text-2xl font-bold mb-4">Chennai</h3>
                <address className="text-muted-foreground text-sm not-italic leading-relaxed">
                  OARC Digital<br />
      ...
      <section className="bg-[#FAF9F6] border-t border-border">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 text-center">
          ...
          <Link href="/">
            <button className="px-8 py-4 bg-[#16a34a] hover:bg-[#15803d] text-white font-semibold rounded-lg transition-colors" data-testid="button-book-call">
              Book a Call
            </button>
          </Link>
        </div>
