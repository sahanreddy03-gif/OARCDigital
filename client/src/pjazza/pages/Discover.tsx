    ...
    <ScrollReveal>
      <div className="pj-section-tight">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
          ...
          <button className="pj-btn-ghost" style={{ gap: 4 }} onClick={() => navigate('/pjazza/sectors')} data-testid="button-all-categories">
    ...
    <div className="pj-section">
      ...
      <ScrollReveal delay={260}>
        <div style={{ marginTop: 16, textAlign: 'center' }}>
          <button className="pj-btn-ghost" style={{ color: 'var(--pj-red)', gap: 6 }} onClick={() => navigate('/pjazza/how-it-works')} data-testid="button-learn-how-works">
