...
import imgSalesperson1 from '../assets/stores/salesperson-1.jpg';
import imgSalesperson2 from '../assets/stores/salesperson-2.jpg';
...
export default function LiveShopSession() {
  ...
  const [, params] = useRoute('/pjazza/live-shop/:storeId');
  const storeId = params?.storeId || 'tec-001';
