  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 10, flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        >
          <div style={{ paddingTop: 24, paddingBottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
            <span
              style={{
                fontSize: 18,
                fontWeight: 800,
        ...
        >
          <div className="pj-portal-content">
            <h1
              style={{
        ...
        <div className="pj-container" style={{ paddingBottom: 40 }}>
          <div style={{ display: 'flex', gap: 1, maxWidth: 600 }}>
            {[
