...
import imgElectronics from '../assets/stores/electronics-store.jpg';
import imgFashion from '../assets/stores/fashion-boutique.jpg';
import imgCar from '../assets/stores/car-dealership.jpg';
import imgRestaurant from '../assets/stores/restaurant.jpg';
import imgProperty from '../assets/stores/property-office.jpg';
import imgSpa from '../assets/stores/spa-center.jpg';
import imgHardware from '../assets/stores/hardware-store.jpg';
import imgPetShop from '../assets/stores/pet-shop.jpg';
import imgYacht from '../assets/stores/yacht-marina.jpg';
import imgSalon from '../assets/stores/hair-salon.jpg';
import imgBookstore from '../assets/stores/bookstore.jpg';
import imgGiftShop from '../assets/stores/gift-shop.jpg';
  ...
  return (
    <ScrollReveal delay={index * 40}>
      <div
        ...
        onClick={() => store.liveNow ? navigate(`/pjazza/live-shop/${store.id}`) : undefined}
          ...
          {store.liveNow ? (
            <div style={{ display: 'flex', gap: 8 }}>
              <button
                ...
                onClick={(e) => { e.stopPropagation(); navigate(`/pjazza/live-shop/${store.id}`); }}
  ...
  return (
    <div className="pj-section" style={{ textAlign: 'center' }}>
      <ScrollReveal>
        ...
        <button className="pj-btn-primary" style={{ minWidth: 200, padding: '18px 24px', fontSize: 16 }} onClick={() => navigate('/pjazza/business/onboard')} data-testid="button-list-your-shop">
