    ...
    <div className="pj-section" style={{ textAlign: 'center' }}>
      <ScrollReveal>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, justifyContent: 'center', maxWidth: 440, margin: '0 auto' }}>
          <button className="pj-btn-primary" style={{ minWidth: 180, padding: '18px 24px', fontSize: 16 }} onClick={() => navigate('/pjazza/business/onboard')} data-testid="button-join-pjazza">
            <span>Join PJAZZA</span>
            <ArrowRight size={18} strokeWidth={2.5} />
          </button>
          <button className="pj-btn-secondary" style={{ minWidth: 160, padding: '16px 24px' }} onClick={() => navigate('/pjazza/discover')} data-testid="button-browse-now">
            Browse Now
          </button>
        </div>
      </ScrollReveal>
