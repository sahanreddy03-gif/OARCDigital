  ...
  return (
    <footer className="bg-foreground text-background py-16">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-5 gap-12 mb-12 md:divide-x md:divide-background/10">
          {/* Brand */}
          ...
          <div className="md:px-8">
            <h4 className="font-black text-lg mb-4 text-background">{servicesCatalog.aiCreative.title}</h4>
          ...
          {/* AI Employees */}
          <div className="md:px-8">
            <h4 className="font-black text-lg mb-4 text-background">{servicesCatalog.aiEmployees.title}</h4>
            <ul className="space-y-2 text-sm text-background/60">
          ...
          {/* Revenue Automation */}
          <div className="md:px-8">
            <h4 className="font-black text-lg mb-4 text-background">{servicesCatalog.revenue.title}</h4>
            <ul className="space-y-2 text-sm text-background/60">
          ...
          {/* Quick Links */}
          <div className="md:px-8">
            <h4 className="font-black text-lg mb-4 text-orange-500">Quick Links</h4>
            <ul className="space-y-2 text-sm text-background/60">
