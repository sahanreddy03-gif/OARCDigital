          ...
          {statsRailData.map((stat, idx) => {
            ...
            return (
              ...
              >
                ...
                <div 
                  className="relative bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center hover:border-[#c4ff4d]/30 transition-colors"
                  data-testid={`stat-tile-${stat.label.toLowerCase()}`}
                >
                  <div className="inline-flex items-center justify-center w-12 h-12 mb-4 rounded-xl bg-[#c4ff4d]/10 border border-[#c4ff4d]/20">
                    <Icon className="w-6 h-6 text-[#c4ff4d]" />
                  </div>
                  ...
                  <p className="text-xs text-white/60 mt-1">{stat.sublabel}</p>
                </div>
              </motion.div>
            );
          })}
