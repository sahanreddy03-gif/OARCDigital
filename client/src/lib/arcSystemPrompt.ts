...
export const INSTANT_RESPONSES: InstantResponseItem[] = [
  {
    ...
    response: `Hey. I'm ARC — OARC Digital's diagnostic engine.
...
Everything's remote — video calls, async updates, real-time dashboards. We've got clients across Europe, Middle East, and beyond.
...
If something I said sparked an idea — or a concern — you know where to find me.
...
Drop a URL — website, Instagram, LinkedIn, whatever.
...
I'll tell you what's broken and what it's costing you. No sugarcoating.`
  },
  {
    ...
    response: `AI's my specialty. But "AI" is vague — so let me ask:
...
Give me something specific and I'll tell you if AI makes sense for it.`
  },
  {
    ...
    response: `OARC Digital — premium AI marketing agency, Malta-based.
...
Quick question though — what made you curious enough to check us out? Even if you're early-stage, I might be able to point you in the right direction.`
  },
  {
...
export const GREETING_MESSAGES = [
  `Hey. I'm ARC — OARC Digital's diagnostic engine.
...
But here's what I need to know — is it a lead problem or a conversion problem?
